        ...
        for i in range(self.numSelectedSentences):
            ...
            for sentence in sentences:
                ...
                if not debug:
                    ...
                    ques_sim = similarity.calculateTokenSimilarity(sentence.tokens, question.tokens)
                ...
                for other in best:
                    ...
                    if not debug:
                        ...
                        sim = similarity.calculateTokenSimilarity(sentence.tokens, other.tokens)
                        # print ques_sim
...
if __name__ == '__main__':
    ...
    print "Result length: {}".format(len(sentences))
